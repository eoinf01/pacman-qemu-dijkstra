      ...
      if (spriteMove)
      {
        ...
        */
            ...
            // uprintf("Vertex: %d", vertex);
               ...
               sprites[0].x = (sprites[0].pathV[pos] % Width) * 16;
               sprites[0].y = (sprites[0].pathV[pos] / Width) * 16;
           ...
           */
            ...
            for(int i=0;i<Height;i++){
                  for(int j=0;j<Width;j++){
                     if( ((i) * Width + (j)) == vertex){
                        uprintf("Actual Vertex: %d",((i *16) * Width + (j *16)));
                        uprintf("Expected Vertex: %d",vertex);
